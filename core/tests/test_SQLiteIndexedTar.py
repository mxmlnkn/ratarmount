...
class TestSQLiteIndexedTarParallelized:
            ...
            try:
                ...
                def testIndex(x, y, z):
                    TestSQLiteIndexedTarParallelized._test_index_creation_and_loading(
                        x, y, z, contents, parallelization
                    )

                # Three optional arguments give 2^3=8 test cases
    ...
    def _test_index_creation_and_loading(tarFileName, fileObject, indexFilePath, contents, parallelization):
        ...
        # When opening a file object without a path, no index should have been created anywhere!
        if indexFilePath is None and fileObject is not None:
