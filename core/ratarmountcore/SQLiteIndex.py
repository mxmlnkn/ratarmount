...
class SQLiteIndex:
    ...
    #     From what I can gather, the SQLite index is used so that adding new columns is backwards compatible.
    ...
    #     I have also checked for all users of SQLiteIndex: TAR, libarchive, RAR, ZIP, SquashFS, but TAR is the only
    #     one that does manual access to the table anyway.
    #     Create the index with the new version and access it with the old one and check whether it was changed.
    __version__ = '0.6.0'
