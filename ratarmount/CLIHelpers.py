...
def parsed_args_to_options(args) -> dict[str, Any]:
    ...
    return {
        ...
        'mountPoint'                   : str(args.mount_point) if args.mount_point else '',
        ...
        'indexFilePath'                : str(args.index_file) if args.index_file else '',
        ...
        'disableUnionMount'            : bool(args.disable_union_mount),
        'maxCacheDepth'                : int(args.union_mount_cache_max_depth),
        'maxCacheEntries'              : int(args.union_mount_cache_max_entries),
        'maxSecondsToCache'            : float(args.union_mount_cache_timeout),
        'indexMinimumFileCount'        : int(args.index_minimum_file_count),
        'logFile'                      : str(args.log_file) if args.log_file else '',
        'enableFileVersions'           : bool(args.file_versions),
        'controlInterface'             : bool(args.control_interface),
        'writeIndex'                   : True,
    }
    # fmt: on
